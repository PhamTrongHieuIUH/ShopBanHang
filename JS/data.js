var dienThoai=[
    {
        ...
        thumb:"Image/Phone/SamSung/1.png",
        code_brand:"SS",
        id:1
        },
        ...
        thumb:"Image/Phone/SamSung/2.png",
        code_brand:"SS",
        id:2
        },
        ...
        thumb:"Image/Phone/SamSung/3.png",
        code_brand:"SS",
        id:3
        },
        ...
        thumb:"Image/Phone/SamSung/4.png",
        code_brand:"SS",
        id:4
        },
...
maytinhbang = maytinhbang.sort(() => Math.random() - 0.5) 
Phukien = Phukien.sort(() => Math.random() - 0.5) 
dongho = dongho.sort(() => Math.random() - 0.5) 
mayin = mayin.sort(() => Math.random() - 0.5) 
mayTinh = mayTinh.sort(() => Math.random() - 0.5) 
var DSSP=[dienThoai,maytinhbang,mayTinh,Phukien,dongho,mayin];

var check_cart_exit=JSON.parse(localStorage.getItem('check_cart_exit'));
if(check_cart_exit==null)
{
    var list_product_buy=[];
    localStorage.setItem('product_cart',JSON.stringify(list_product_buy));
}
